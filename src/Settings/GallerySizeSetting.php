...
/**
 * Provides functionality for the Gallery Size plugin setting.
 *
 * @since 3.0.0
 */
final class GallerySizeSetting implements Setting {
	...
	/**
	 * Returns the settings field DTO for rendering the Gallery Size setting.
	 *
	 * @since 3.0.0
	 *
	...
	/**
	 * Renders the Gallery Size settings field in the plugin settings page.
	 *
	 * @since 3.0.0
	 *
