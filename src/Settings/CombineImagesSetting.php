...
/**
 * Provides functionality for the Combine Images plugin setting.
 *
 * @since 3.0.0
 */
final class CombineImagesSetting implements Setting {
	 ...
	 * @since 3.0.0
	 *
	 * @return bool True if combine images is enabled, false otherwise.
	 */
	...
	/**
	 * Returns the settings field DTO for rendering the Combine Images setting.
	 *
	 * @since 3.0.0
	 *
	...
	/**
	 * Renders the Combine Images settings field in the plugin settings page.
	 *
	 * @since 3.0.0
	 *
